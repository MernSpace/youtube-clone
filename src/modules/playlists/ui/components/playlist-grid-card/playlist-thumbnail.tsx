    ...
    return (
        <div className={cn("relative pt-3 group", className)}>
            ...
            <div className="relative">
                ...
                />
                <div
                    className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-[98.5%] overflow-hidden rounded-xl bg-black/20 aspect-video"
                />
            ...
            <div className="absolute bottom-2 right-2 px-1 py-0.5 rounded bg-black/80 text-xs font-medium flex items-center gap-x-1 text-white">
